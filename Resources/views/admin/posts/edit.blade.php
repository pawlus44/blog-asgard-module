...
{!! Form::open(['route' => ['admin.blog.post.update', $post->id], 'method' => 'put']) !!}
       ...
       {!! Form::hidden("return", false, ['class' => 'updat-and-return-input']) !!}
        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat btn-update-and-back">{{ trans('core::core.button.update and back') }}</button>
...
<script type="text/javascript">
    $( document ).ready(function() {
        ...
        $('.btn-update-and-back').click(function(){
            $('.updat-and-return-input').val(1);
        });
    });
</script>
@stop

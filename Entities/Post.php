...
class Post extends Model implements TaggableInterface
{
    ...
    public $translatedAttributes = ['title', 'slug', 'content', 'short_content'];
    protected $fillable = ['category_id', 'user_id', 'status', 'title', 'slug', 'short_content', 'content', 'publish_date' /*'created_at'*/];
    ...
    {
        $document = $this->files()->where('zone', 'document')->get();
    ...
    {
        //return $this->filesByZone('document')->get();
